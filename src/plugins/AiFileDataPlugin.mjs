...
const AiFileDataPlugin = {
  ...
  apply: (Base) =>
    ...
    class TinyAiInstance2FileData extends Base {
      /** @typedef {import('../Core.mjs').SessionData<AICData>} SessionData */
      /**
       ...
       * @param {Record<string, import("../Core.mjs").CustomValidatorFunction>} [modValidators] - Custom validation functions.
       */
